...
/**
 * @author LeiKang
 * @time 2017/1/23 送礼物动画工具类
 */
public class GiftAnimationUtil
{

    // 礼物飞入动画
    public static ObjectAnimator createFlyFromLtoR(final View target, float star, float end, int duration,
    ...
    // 送礼物数字变化动画 做三个属性的变化 缩放 透明度
    public static ObjectAnimator scaleGiftNum(final TextView target, int num)
    {
        PropertyValuesHolder anim4 = PropertyValuesHolder.ofFloat("scaleX", 1.7f, 0.8f, 1f);
    ...
    // 向上移动并透明消失动画
    public static ObjectAnimator createFadeAnimator(final View target, float star, float end, int duration,
                                                    int startDelay)
    {
    ...
    public static AnimatorSet startAnimation(ObjectAnimator animator1, ObjectAnimator animator2,
                                             ObjectAnimator animator3, ObjectAnimator animator4, ObjectAnimator animator5)
    {
